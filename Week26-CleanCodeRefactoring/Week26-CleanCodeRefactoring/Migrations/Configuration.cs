namespace Week26_CleanCodeRefactoring.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<Week26_CleanCodeRefactoring.Models.ShopContext>
    {
        public Configuration()
        {
            AutomaticMigrationsEnabled = false;
            ContextKey = "Week26_CleanCodeRefactoring.Models.ShopContext";
        }

        protected override void Seed(Week26_CleanCodeRefactoring.Models.ShopContext context)
        {
